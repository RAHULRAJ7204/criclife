...
<div class="w3-content w3-display-container" style="margin-top:-1%;">
          ...
          <div id="id01" class="modal">
              ...
              box-sizing: border-box;height: 10%" class="textfield" type="text" placeholder="Enter First Name" name="fname" id="first" ><br>

                <label><b>Last Name</b></label>
                <input style="width: 100%;padding: 12px 20px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;
              box-sizing: border-box;height: 10%" class="textfield" type="text" placeholder="Enter Last Name" name="lname" id="last" ><br>
              ...
              box-sizing: border-box;height: 10%" class="textfieldstyle" type="date" placeholder="Enter Last Name" name="dob" id="dod" ><br>
                ...
                <input style="width: 100%;padding: 12px 20px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;
              box-sizing: border-box;height: 10%"  class="textfield" type="text" placeholder="Country Name" onkeyup="key(this)"   name="cname" id="cname" ><br>
...
<div class="row">
  <div class="column Register">
    <div class="content">
      <div class="table">
                    ...
                    <td> <input type="text" placeholder="Enter Player Name" id="name" name="Name" ></td>
                     <td> <label>State</label></td>
                    <td><input style="margin-left:0%;" type="text" placeholder="Enter State" id="state" name="State" ></td>
                    
                    </tr>
                           
                    <tr>
                    <td><label>Father Name</label></td>
                    <td><input type="text" placeholder="Enter Father Name" id="father" name="Father" ></td>
                    <td><label>District</label></td>
                    <td><input style="margin-left:0%;" type="text" placeholder="Enter District" id="district" name="District" ></td>
                    </tr>
                        
                    <tr>
                    <td><label>Mother Name</label></td>
                    <td> <input style="margin-left: 10px;" type="text" placeholder="Enter Mother Name" id="mother" name="mother" >
                    </td>
                    ...
                    <td><input type="value" placeholder="Enter weight"  maxlength="3" name="weight" id="weight" ></td>
                    </tr>
  ...
  <div class="column News">
                          ...
                          <p id="demo">Corporate Cricket League 2018.<br>Sun, 29 Apr 7:00AM - Sun, 20 May 6:00PM<br>contact:7204266841</p>
...
<footer style="width: 100%;height:40%;margin-top:50px;background-color:black;">
                          ...
                          font-size:16px;font-family: 'IBM Plex Sans', sans-serif;color: rgba(280,280,255,0.9);">E-city Bangalore India</p></td>
                          </tr>
                          <tr>
                          ...
                          <td><p style="margin-top: 15px;margin-left: 15px;font-size:16px;font-family: 'IBM Plex Sans', sans-serif;color: rgba(280,280,255,0.9);">+917204266841</p></td>                   
                          </tr>
                          ...
                          <td><p style="color:white;margin-top: 15px;margin-left: 15px;font-size:16px; color: white;font-family: 'PT Sans Narrow', sans-serif;"><a href="mailto:criclife@gmail.com" style="text-decoration: none; font-family: 'IBM Plex Sans', sans-serif;color: rgba(280,280,255,0.9);">Criclife@gmail.com</a></p></td>                   
                          </tr>
                          </table>
                          </div>
                          <div class="about-us">
                          <h1 style="font-size: 30px;margin-top:20px; font-family: 'IBM Plex Sans', sans-serif;color: rgba(280,280,255,0.9);">About My Company</h1>
                          <p style="margin-top: 0px;text-align: justify; font-size:12px;font-family: 'IBM Plex Sans', sans-serif;color: rgba(280,280,255,0.7);">Cricket club management project is designed with the motive of managing a cricket club. This software system consists of various online booking and management functionaries needed by a cricket club.</p>
                          <tr>
