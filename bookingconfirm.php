    ...
    <?php
          if(isset($_SESSION["emailid"]))
           {   
              ...
              echo "<a  style='margin-left: 64%;
              margin-top: 13%;
              position: absolute;
              font-size: 50%;
              text-decoration: none;' href='logout.php'><button class='btnlog' style='width:100px;position:relative;right:-333px;height:30px;background-color: #f4511e;border:none;top:-145px;cursor: pointer;color:white;'>Logout</button></a>";
            ...
            <form action="bookingconfirm.php" method="post" enctype="multipart/form-data">
              <table style="margin-left: 150px;">
                <tbody>
                        ...
                        <td><input type="email" name="email" placeholder="Enter your name" required="required"></td>
                        </tr>
                        <tr>
                        <td><label>Date </label></td>
                        <td><input type="date" name="dob" placeholder="Enter your name" required="required"></td>
                        </tr>
                        <tr>
                        <td><label>Timing</label></td>
                        <td><input id="timebox" type="time" name="booktime" placeholder="Enter your name" required="required"></td>
                        </tr>
                        </tr>
                        <tr>
                        <td><label>Contact No</label></td>
                        <td><input id="timebox" type="text" maxlength="10" onkeyup="keynum(this)" name="phoneno" placeholder="Enter your name" required="required"></td>
                        </tr>
                        <tr>
...
<div "><td style="display: inline-flex;"><img  src="image/paytm.jpg" width="200" height="200">
<img src="image/phonepe.jpg" width="200" height="200"></td></div>
