...
<img style="margin-left:72%;position: relative;top:-12px;width: 100px;height: 100px;" src="image/admin.png">
...
{   
echo "<h1 style='margin:10px -165px;float:right; font-size:%; margin-right:px;position'><a style='text-decoration:none; color:black;border:px black solid; border-radius:px;background-color:;font-family: monospace;font-size:16px;'>  Hey,".$_SESSION["emailid"]."</a></h1>";
...
<td><input type="file" name="image" id="image" required="required" /></td>
  ...
  <tr><td><input style="width: 89%;padding:10px 10px 10px 10px;border-radius:5px;color: black;font-size:15px;" type="text " name="price" required="required" placeholder="Enter the price "></td></tr>
<tr>
...
$result = mysqli_query($con,$query) or die (mysqli_error($con)); 
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        ?>
        <h1 style="font-size:30px;font-family: monospace;color: white;text-align: center; background-color: black;">Clube Manager</h1> 
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr id='styletable2' >";
                ...
                echo '<td id="styletable2"><b><font color="#663300"><a style="text-decoration:none;font-size:23px;font-family: monospace;color:red";" href=".php?id=' . $row['id'] . '"></a></font></b></td>';
        ...
        <form action="adminindex.php" enctype="multipart/form-data" method="post" style="background-color: white">
            ...
            <td><input type="text" name="locationid" placeholder="enter the event name" required="required"></td>
            <td><input type="text" name="shortdesc" placeholder="enter the event name" required="required"></td>
