  ...
  if(isset($_GET["id"]))
    {
                  ...
                  echo "<td><input class='inputbox' type='text' name='Name' required='required' value='".$row["Name"]."' ></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>state</td>";
                   echo "<td ><input class='inputbox' type='text' name='State' value='".$row["State"]."'></td>";
                  echo'</tr>';
                  echo'</tr>';
                  echo "<td id='styletable2'>Father Name</td>";
                    echo "<td><input class='inputbox' type='text' name='Father' value='".$row["Father"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>District</td>";
                   echo "<td><input class='inputbox' type='text' name='District' value='".$row["District"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>Mother Name</td>";
                  echo "<td><input class='inputbox' type='text' name='mother' value='".$row["mother"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>Date of Birth</td>";
                  echo "<td><input class='inputbox' type='text' name='Birth' value='".$row["Birth"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>Skill</td>";
                  echo "<td><input class='inputbox' type='text' name='skill' value='".$row["skill"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>Date of Application</td>";
                   echo "<td><input class='inputbox' type='text' name='Application' value='".$row["Application"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>Gender</td>";
                   echo "<td><input  class='inputbox' type='text' name='gen' value='".$row["gen"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>Mobile</td>";
                   echo "<td><input class='inputbox' type='text' name='mobile' maxlength='10' onkeyup='keynum(this)' value='".$row["mobile"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>Email Id</td>";
                  echo "<td><input class='inputbox' type='text' name='email' value='".$row["email"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>Adhar card</td>";
                       echo "<td><input class='inputbox' type='text' name='Adhar' value='".$row["Adhar"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>Height</td>";
                    echo "<td><input class='inputbox' type='text' name='height' value='".$row["height"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>weight</td>";
                       echo "<td><input class='inputbox' type='text' name='weight' value='".$row["weight"]."'></td>";
                  echo'</tr>';
