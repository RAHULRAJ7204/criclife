  ...
  if(isset($_GET["id"]))
    {
                  ...
                  echo "<td><input class='inputbox' type='text' name='ename' value='".$row["ename"]."' ></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>event location</td>";
                  echo "<td ><input class='inputbox' type='text' name='locationid' value='".$row["locationid"]."'></td>";
                  echo'</tr>';
                  echo'</tr>';
                  echo "<td id='styletable2'>Event description</td>";
                  echo "<td><input class='inputbox' type='text' name='shortdesc' value='".$row["shortdesc"]."'></td>";
                  echo'</tr>';
                  echo'<tr>';
                  echo "<td id='styletable2'>Event Date</td>";
                  echo "<td><input class='inputbox' type='date' name='eventdate' value='".$row["eventdate"]."'></td>";
