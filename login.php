   ...
   if(isset($_POST['sub']))
{
 ...
 if($emailid!='' && $pass!='')
 {
   $sql="SELECT * FROM admin WHERE emailid='$emailid' and pass='$pass'";
    $query = mysqli_query($con,$sql) or die (mysqli_error());
   $arr=mysqli_fetch_array($query);
   if(($arr['emailid']==$emailid) and($arr['pass']==$pass))
   {
  ...
  header('location:adminindex.php');
   echo "<h1 style='margin:-200px 0px;float:right; font-size:20px; margin-right:4px;'><a href = 'adminindex.php' style='text-decoration:none; color:black;border:1px black solid; border-radius: 2px;'> Hi ".$_SESSION["emailid"]."</a></h1>";
